...
<flux:main>
    ...
    <div class="flex justify-end mb-4 gap-4">
        <div>
            ...
            <form action="{{ route('tenant.store') }}" method="post">
                ...
                <flux:select>
                    ...
                    <flux:select.option name="busscat_id">Pilih Data</flux:select.option>
        ...
        <tr class="border-b text-center">
            ...
            <td contenteditable="true" class="p-3 font-bold">Nama Tenant</td>
            <td contenteditable="true" class="p-3 font-bold">Nomor Telepon</td>
            <td contenteditable="true" class="p-3 font-bold">Email</td>
            <td contenteditable="true" class="p-3 font-bold">Nama PIC</td>
            <td contenteditable="true" class="p-3 font-bold">Nama Brand</td>
            <td contenteditable="true" class="p-3 font-bold">Alamat</td>
        ...
        @foreach ($daftar_tenant as $tenant)
            <tr class="border-b">
                <td contenteditable="true" class="p-3">{{ $tenant->busscat->name }}</td>
                <td contenteditable="true" class="p-3">{{ $tenant->tenant_name }}</td>
                <td contenteditable="true" class="p-3">{{ $tenant->phone }}</td>
                <td contenteditable="true" class="p-3">{{ $tenant->email }}</td>
                <td contenteditable="true" class="p-3">{{ $tenant->pic_name }}</td>
                <td contenteditable="true" class="p-3">{{ $tenant->brand_name }}</td>
                <td contenteditable="true" class="p-3">{{ $tenant->address }}</td>
                <td class="p-3">
